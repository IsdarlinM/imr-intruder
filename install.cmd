...
call :check_python_path "%LOCALAPPDATA%\Programs\Python\Python314\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%LOCALAPPDATA%\Programs\Python\Python313\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%LOCALAPPDATA%\Programs\Python312\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%LOCALAPPDATA%\Programs\Python\Python311\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%LOCALAPPDATA%\Programs\Python310\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%ProgramFiles%\Python314\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%ProgramFiles%\Python313\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%ProgramFiles%\Python312\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%ProgramFiles%\Python311\python.exe"
if defined PYTHON_CMD exit /b 0
call :check_python_path "%ProgramFiles%\Python310\python.exe"
exit /b 0
